                    ...
                    "click": [
                        ...
                        function sendForm() {
                            if (fname_b && lname_b && uname_b
                                ...
                                post(api().createUser.endpoint, 'create_user_form', function (data) {
                                    post("https://localhost:44358/api/files", 'picform', function (data) {
                                        post("https://localhost:44358/api/files", 'resumeform', function (data) {
