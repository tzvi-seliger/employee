...
namespace TechdinAPI.Helpers
{
    public static class FilesHelper
    {
        ...
        {
            string filePath = $@"..\..\users\{username}";
            ...
            if (file.Length > 0)
            {
                ...
                {
                    fileName = $"{username}_profileimg";
                }
                else if (file.ContentType.Contains("application"))
                {
                    fileName = $"{username}_resume";
                }
                ...
                return $"../../users/{username}/{fileName}{extension}";
            }
            return "";
        }
    }
